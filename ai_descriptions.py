...
def generate_card_description(card_title: str, spread_type: str) -> str:
    prompt = f"""
    Ты — профессиональный таролог с 20-летним опытом практики, глубоко знающий классическую систему Таро (Уэйта-Смит), архетипы Юнга, нумерологию карт и традиции разных школ (Марсельское Таро, Тота, интуитивное Таро).
